...
const (
	...
	SettingKeyResearchDrawingGPTImageAPIKey                   = "research_drawing_gpt_image_api_key"
	SettingKeyResearchDrawingGPTImageBaseURL                  = "research_drawing_gpt_image_base_url"
