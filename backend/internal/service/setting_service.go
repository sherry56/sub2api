...
func (s *SettingService) GetPublicSettings(ctx context.Context) (*PublicSettings, error) {
	keys := []string{
		...
		SettingKeyResearchDrawingMethodOptimizationEnabled,
		SettingKeyResearchDrawingMethodOptimizationDefaultEnabled,
	...
	return &PublicSettings{
		...
		SiteName:                         s.getStringOrDefault(settings, SettingKeySiteName, "XiaoHuiAPI"),
		...
		ResearchDrawingMethodOptimizationEnabled:        !isFalseSettingValue(settings[SettingKeyResearchDrawingMethodOptimizationEnabled]),
		ResearchDrawingMethodOptimizationDefaultEnabled: settings[SettingKeyResearchDrawingMethodOptimizationDefaultEnabled] == "true",
...
func (s *SettingService) GetPublicSettingsForInjection(ctx context.Context) (any, error) {
	...
	return &PublicSettingsInjectionPayload{
		...
		ResearchDrawingMethodOptimizationDefaultEnabled: settings.ResearchDrawingMethodOptimizationDefaultEnabled,
...
func (s *SettingService) buildSystemSettingsUpdates(ctx context.Context, settings *SystemSettings) (map[string]string, error) {
	...
	settings.ResearchDrawingExpMode = normalizeResearchDrawingExpMode(settings.ResearchDrawingExpMode)
	settings.ResearchDrawingRetrievalSetting = normalizeResearchDrawingRetrievalSetting(settings.ResearchDrawingRetrievalSetting)
	settings.ResearchDrawingNumCandidates = clampIntWithDefault(
		settings.ResearchDrawingNumCandidates,
		researchDrawingNumCandidatesMin,
		researchDrawingNumCandidatesMax,
		researchDrawingDefaultNumCandidates,
	)
	settings.ResearchDrawingAspectRatio = normalizeResearchDrawingAspectRatio(settings.ResearchDrawingAspectRatio)
	settings.ResearchDrawingMaxCriticRounds = clampIntWithDefault(
		settings.ResearchDrawingMaxCriticRounds,
		researchDrawingMaxCriticRoundsMin,
		researchDrawingMaxCriticRoundsMax,
		researchDrawingDefaultMaxCriticRounds,
	)
	settings.ResearchDrawingMainModelName = normalizeResearchDrawingMainModelName(
		settings.ResearchDrawingMainModelName,
		researchDrawingDefaultMainModelName,
	)
	settings.ResearchDrawingImageGenModelName = normalizeResearchDrawingImageModelName(
		settings.ResearchDrawingImageGenModelName,
	...
	if !settings.ResearchDrawingMethodOptimizationEnabled {
		settings.ResearchDrawingMethodOptimizationDefaultEnabled = false
	}
	...
	updates[SettingKeyResearchDrawingExpMode] = settings.ResearchDrawingExpMode
	updates[SettingKeyResearchDrawingRetrievalSetting] = settings.ResearchDrawingRetrievalSetting
	updates[SettingKeyResearchDrawingNumCandidates] = strconv.Itoa(settings.ResearchDrawingNumCandidates)
	updates[SettingKeyResearchDrawingAspectRatio] = settings.ResearchDrawingAspectRatio
	...
	updates[SettingKeyResearchDrawingMethodOptimizationDefaultEnabled] = strconv.FormatBool(settings.ResearchDrawingMethodOptimizationDefaultEnabled)
...
// IsAnthropicCacheTTL1hInjectionEnabled checks whether Anthropic cache ttl injection is enabled.
...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		// Group scheduling and gateway defaults.
		...
		SettingKeyResearchDrawingExpMode:                          researchDrawingDefaultExpMode,
		SettingKeyResearchDrawingRetrievalSetting:                 researchDrawingDefaultRetrievalSetting,
		SettingKeyResearchDrawingNumCandidates:                    strconv.Itoa(researchDrawingDefaultNumCandidates),
		SettingKeyResearchDrawingAspectRatio:                      researchDrawingDefaultAspectRatio,
		...
		SettingKeyResearchDrawingMethodOptimizationDefaultEnabled: "false",
	}
...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	result.ResearchDrawingExpMode = normalizeResearchDrawingExpMode(settings[SettingKeyResearchDrawingExpMode])
	result.ResearchDrawingRetrievalSetting = normalizeResearchDrawingRetrievalSetting(settings[SettingKeyResearchDrawingRetrievalSetting])
	result.ResearchDrawingNumCandidates = parseIntWithDefault(
		settings[SettingKeyResearchDrawingNumCandidates],
		researchDrawingDefaultNumCandidates,
	)
	result.ResearchDrawingNumCandidates = clampIntWithDefault(
		result.ResearchDrawingNumCandidates,
		researchDrawingNumCandidatesMin,
		researchDrawingNumCandidatesMax,
		researchDrawingDefaultNumCandidates,
	)
	result.ResearchDrawingAspectRatio = normalizeResearchDrawingAspectRatio(settings[SettingKeyResearchDrawingAspectRatio])
	result.ResearchDrawingMaxCriticRounds = parseIntWithDefault(
		settings[SettingKeyResearchDrawingMaxCriticRounds],
		researchDrawingDefaultMaxCriticRounds,
	)
	result.ResearchDrawingMaxCriticRounds = clampIntWithDefault(
		result.ResearchDrawingMaxCriticRounds,
		researchDrawingMaxCriticRoundsMin,
		researchDrawingMaxCriticRoundsMax,
		researchDrawingDefaultMaxCriticRounds,
	)
	result.ResearchDrawingMainModelName = normalizeResearchDrawingMainModelName(
		settings[SettingKeyResearchDrawingMainModelName],
		researchDrawingDefaultMainModelName,
	)
	result.ResearchDrawingImageGenModelName = normalizeResearchDrawingImageModelName(
	...
	if result.ResearchDrawingUnitPrice <= 0 {
		result.ResearchDrawingUnitPrice = researchDrawingDefaultUnitPrice
	}
	result.ResearchDrawingMethodOptimizationEnabled = !isFalseSettingValue(settings[SettingKeyResearchDrawingMethodOptimizationEnabled])
	result.ResearchDrawingMethodOptimizationDefaultEnabled = settings[SettingKeyResearchDrawingMethodOptimizationDefaultEnabled] == "true"
	if !result.ResearchDrawingMethodOptimizationEnabled {
		result.ResearchDrawingMethodOptimizationDefaultEnabled = false
	}
...
const (
	researchDrawingDefaultExpMode             = "demo_planner_critic"
	researchDrawingDefaultRetrievalSetting    = "auto"
	researchDrawingDefaultNumCandidates       = 1
	...
	researchDrawingMaxCriticRoundsMin         = 1
	researchDrawingMaxCriticRoundsMax         = 5
...
func clampIntWithDefault(value, min, max, fallback int) int {
...
func normalizeResearchDrawingExpMode(raw string) string {
	switch strings.TrimSpace(raw) {
	case "demo_full", "demo_planner_critic":
		return strings.TrimSpace(raw)
	default:
		return researchDrawingDefaultExpMode
	}
}

func normalizeResearchDrawingRetrievalSetting(raw string) string {
	switch strings.TrimSpace(raw) {
	case "auto", "manual", "random", "none":
		return strings.TrimSpace(raw)
	default:
		return researchDrawingDefaultRetrievalSetting
	}
}

func normalizeResearchDrawingAspectRatio(raw string) string {
	switch strings.TrimSpace(raw) {
	case "21:9", "16:9", "3:2":
		return strings.TrimSpace(raw)
	default:
		return researchDrawingDefaultAspectRatio
	}
}
...
func normalizeResearchDrawingModelName(raw, fallback string) string {
	...
	if len(trimmed) > researchDrawingModelNameMaxLen {
		return trimmed[:researchDrawingModelNameMaxLen]
	}
	return trimmed
}
