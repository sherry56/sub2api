...
const routes: RouteRecordRaw[] = [
  ...
  {
    path: '/research-drawing',
    redirect: '/admin/research-drawing'
  },
  {
    path: '/custom/:id',
    name: 'CustomPage',
  ...
  },
  {
    ...
    name: 'ResearchDrawing',
    component: () => import('@/views/user/ResearchDrawingUserView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: false,
      title: 'Research Drawing',
      titleKey: 'researchDrawing.title',
      descriptionKey: 'researchDrawing.description',
      breadcrumbs: [
        { label: '科研绘图', to: '/admin/research-drawing' }
      ]
    }
  },
  {
...
router.beforeEach((to, _from, next) => {
  ...
  if (to.name === 'CustomPage') {
    ...
    if (menuItem?.label) {
      const siteName = appStore.siteName || 'XiaoHuiAPI'
