export default {
  ...
  researchDrawing: {
    ...
    input: {
      ...
      normalUserHint: 'Regular users only need method content and caption; the system will use the default parameters.',
      keepExistingSecret: 'Already configured; leave empty to keep unchanged',
    ...
    run: {
      ...
      stepsTitle: 'Run Flow',
      idleStatus: 'Enter content and click generate to view progress and candidate images.',
      ...
      openLargePreview: 'Open large preview',
      largePreviewTitle: 'Large Preview',
    ...
    labels: {
      ...
      gptImageAPIKey: 'GPT Image 2 API Key',
      gptImageBaseURL: 'GPT Image 2 Base URL',
