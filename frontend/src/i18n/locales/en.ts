export default {
  ...
  researchDrawing: {
    ...
    run: {
      ...
      progressDesc: 'Generated images will appear here automatically. Click an image to view it larger. Failed generations are not charged.',
      ...
      previewStatus: 'The task has been submitted and is generating.',
      previewSubmitted: 'Input passed frontend validation and is being submitted to the sub2api orchestration endpoint.',
      submittedWithCharge: 'The task has been submitted and is generating.',
      ...
      generationHistoryTitle: 'Generation Records',
      generationHistoryEmpty: 'No generation records yet',
      jobId: 'Job ID',
