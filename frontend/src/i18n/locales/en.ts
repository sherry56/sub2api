export default {
  ...
  nav: {
    ...
    researchDrawing: 'Research Drawing',
  },
  ...
  admin: {
    ...
    settings: {
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'XiaoHuiAPI',
  ...
  researchDrawing: {
    ...
    userHero: {
      ...
      tips: {
        first: 'Start from a template style, then add your own research content.',
        second: 'Each submission consumes 1 generation quota.',
        third: 'View the high-resolution image in Candidate Results after generation.',
      },
    },
    adminOnlyTitle: 'Admin permissions required',
    adminOnlyDesc: 'This page is a system-level configuration area. Please contact an administrator to modify parameters.',
    examplesTitle: 'Example Figures',
    examplesDesc: 'These examples show the visual effect expected from the generation page.',
    settingsTitle: 'Default Generation Parameters',
    settingsDesc: 'Only the essential global defaults are kept here to control quality and cost.',
    examples: {
      frameworkTitle: 'Paper Framework Diagram',
      frameworkDesc: '',
      workflowTitle: 'Mechanism Flow Diagram',
      workflowDesc: '',
      datasetTitle: 'Statistical Chart',
      datasetDesc: '',
    },
    input: {
      title: 'Input & Parameters',
      desc: 'Load a reference template first, then rewrite it to improve structural stability and output consistency.',
      loadMethodExample: 'Load Example (Method)',
      loadCaptionExample: 'Load Example (Caption)',
      noExample: '(Do not load)',
      methodContent: 'Method Content',
      methodOptimize: 'Enable method-content optimization (uses GPT-5.3 to rewrite as focused Markdown; off by default)',
      optimizeUnavailable: 'Method-content optimization is not enabled.',
      caption: 'Caption',
      generationMode: 'Generation Mode (assigned by admin)',
      defaultMode: 'Budget Tier',
      customMode: 'Custom Combination (manual)',
      customModeHint: 'Custom combination mode is active. Generation will run with the parameters below.',
      normalUserHint: 'Regular users only need method content and caption; the system will use the admin-assigned default configuration.',
      validationRequired: 'Please enter method content first.',
      examples: {
        paperVizAgentFramework: 'PaperVizAgent Framework',
      },
      placeholders: {
        methodContent: 'Paste a paper method description or structured prompt',
        caption: 'Optional: figure title or figure description',
        defaultConfig: 'Leave empty to use configured default',
      },
    },
    run: {
      title: 'Run Generation',
      desc: 'PaperBanana background task flow: submit, enter the wait page, then poll status through short requests.',
      progressTitle: 'Run Progress',
      progressDesc: 'Generated images will appear here automatically. Click an image to view it larger.',
      start: 'Run Generation',
      applyQuota: 'Apply for Quota',
      applyQuotaHint: 'In the PaperBanana source this button jumps to the quota application area.',
      unitPrice: 'Unit Price',
      quotaNeed: 'Estimated Quota',
      estimatedTime: 'Estimated Time',
      noHistory: '3-4 minutes',
      noHistoryHint: 'No record yet, using a random 3-4 minute estimate',
      runningBanner: 'Generation is running in the background. This page polls status with short requests and will not disconnect during long waits.',
      routesTitle: 'Run Endpoints',
      routes: {
        submit: 'POST /generate',
        wait: 'GET /generate/wait/{job_id}',
        poll: 'GET /generate/job/{job_id} (poll every 2 seconds)',
        finish: 'GET /generate/finish/{job_id}',
      },
      stepsTitle: 'Run Flow',
      idleStatus: 'Waiting for input. The PaperBanana source posts to /generate and creates a background task.',
      previewStatus: 'The task has been submitted to the sub2api orchestration endpoint; sub2api charges the balance and hands generation to PaperBanana.',
      previewSubmitted: 'Input passed frontend validation and is being submitted to the sub2api orchestration endpoint.',
      submittedWithCharge: 'Task submitted. Charged {charge} from the sub2api balance.',
      submitFailed: 'Failed to submit research drawing task',
      statusFailed: 'Failed to fetch research drawing task status',
      imagesFailed: 'Failed to load generated images',
      ...
      saveHint: 'Candidate images are temporary results. Download the 2K image soon to save it locally.',
      emptyResults: 'Candidate images are temporary results. Download the 2K image soon to save it locally.',
      loadingImages: 'Loading generated images...',
      download2k: 'Download 2K Image',
      generatedAt: 'Generated at',
      sessionHistoryTitle: 'This Session History',
      sessionHistoryLimit: 'Latest {count}',
      jobId: 'Job ID',
      candidateLabel: 'Candidate #{id}',
      resultAlt: 'Research drawing candidate {id}',
      statuses: {
        idle: 'Idle',
        queued: 'Queued, generating...',
        running: 'Generating... / elapsed about {time}',
        done: 'Redirecting to results...',
        error: 'Generation failed',
        missing: 'Task does not exist or has expired',
      },
      steps: {
        validate: 'Validate input, mode, and remaining quota',
        spawn: 'Create background task with spawn_generation_job',
        poll: 'Poll task status on the wait page',
        finish: 'Open candidate results after completion',
        export: 'View full image, download PNG, or save to gallery',
      },
    },
    sections: {
    ...
    labels: {
      ...
      methodOptimizationEnabled: 'Method-content Optimization',
      methodOptimizationDefaultEnabled: 'Enable Method Optimization by Default',
      unitPrice: 'Unit Price',
    },
    options: {
      enabled: 'Enabled',
    ...
    expMode: {
      demoPlannerCritic: 'demo_planner_critic (without stylist)',
      demoFull: 'demo_full (with stylist)',
    },
    retrieval: {
      auto: 'auto',
      manual: 'manual',
    ...
    scenesTitle: 'Typical Scenarios & Layout References',
    scenes: {
      paperFramework: 'Use for end-to-end framework diagrams in papers (methods, workflow, architecture).',
      experimentWorkflow: 'Use for experiment or algorithm process illustrations with cleaner structure.',
      statisticsFigure: 'Use for SCI-style statistical figure drafts with consistent color language.',
    },
    tipsTitle: 'Usage Tips',
    tips: {
      first: '1) Start from the template style, then rewrite it with your own method content.',
      second: '2) Each submission consumes 1 quota unit, purchased at the administrator-configured price.',
      third: '3) After generation, switch to Candidate Results to view the full-size image.',
    },
    loadFailed: 'Failed to load research drawing settings',
    saveFailed: 'Failed to save research drawing settings',
  },
