export default {
  ...
  researchDrawing: {
    ...
    run: {
      ...
      progressTitle: '运行进度',
      progressDesc: '生成结果会自动出现在这里，点击图片可查看大图。生成失败不扣费。',
      start: '运行生成',
      unitPrice: '单次价格',
      quotaNeed: '预计消耗次数',
      ...
      previewStatus: '任务已提交，正在生成。',
      previewSubmitted: '输入已通过前端预检，正在提交 sub2api 编排接口。',
      submittedWithCharge: '任务已提交，正在生成。',
      ...
      generatedAt: '生成时间',
      generationHistoryTitle: '生图记录',
      generationHistoryEmpty: '暂无生图记录',
      jobId: '任务 ID',
